...
define Package/$(PKG_NAME)
	...
	DEPENDS:=+luci-base +wget +iptables-nft +coreutils-base64 +coreutils +coreutils-nohup +bash +ipset +libustream-openssl +curl +jsonfilter +ca-certificates +kmod-nft-tproxy +kmod-tun
	PKGARCH:=all
